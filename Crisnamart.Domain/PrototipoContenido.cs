...
public class PrototipoContenido {
	...
	public static List<ProductCardModel> GetOfertasDiarias() => [
		new ProductCardModel {
			...
			ImagePath = "images/products/product-img-1.jpg",
			Price =130m,
			OldPrice =180m,
			Rating =4.5,
			RatingCount =120,
		...
		new ProductCardModel {
			...
			ImagePath = "images/products/product-img-2.jpg",
			Price =95m,
			OldPrice =120m,
			Rating =4.5,
			RatingCount =89,
		...
		new ProductCardModel {
			...
			ImagePath = "images/products/product-img-3.jpg",
			Price =130m,
			OldPrice =180m,
			Rating =4.5,
			RatingCount =47,
